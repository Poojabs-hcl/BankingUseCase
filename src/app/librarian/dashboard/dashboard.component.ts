...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, FormsModule, MatListModule, MatCardModule, MatFormFieldModule, MatInputModule, MatTableModule],
...
export class LibrarianDashboardComponent {
  ...
  searchMemberBooks(): void {
    const memberId = this.idform.get('memberId')?.value?.trim();
